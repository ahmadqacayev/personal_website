...
class AdminPageController extends Controller
{
    ...
    public function portfolios_update(Request $request){
        ...
        if ($request->hasFile('portfolios_banner')){
            ...
            if(file_exists(public_path('uploads/'.$page_data->portfolios_banner)))
            {
    ...
    public function about_update(Request $request){
        ...
        if ($request->hasFile('about_photo')){
            ...
            if(file_exists(public_path('uploads/'.$page_data->about_photo)) && $page_data->about_photo != "")
            {
        ...
        if ($request->hasFile('about_banner')){
            ...
            if(file_exists(public_path('uploads/'.$page_data->about_banner)) && $page_data->about_photo != "")
            {
    ...
    public function about_photo_delete(){
        ...
        if (file_exists(public_path('uploads/'.$row_data->about_photo)) && $row_data->about_photo != "")
        {
    ...
    public function contact_update(Request $request){
        ...
        if ($request->hasFile('contact_banner')){
            ...
            if(file_exists(public_path('uploads/'.$page_data->contact_banner)))
            {
    ...
    public function blog_update(Request $request){
        ...
        if ($request->hasFile('blog_banner')){
            ...
            if(file_exists(public_path('uploads/'.$page_data->blog_banner)))
            {
    ...
    public function archive_update(Request $request){
        ...
        if ($request->hasFile('archive_banner')){
            ...
            if(file_exists(public_path('uploads/'.$page_data->archive_banner)))
            {
    ...
    public function search_update(Request $request){
        ...
        if ($request->hasFile('search_banner')){
            ...
            if(file_exists(public_path('uploads/'.$page_data->search_banner)))
            {
