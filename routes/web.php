...
Route::get('/admin/portfolio_category/add', [AdminPortfolioCategoryController::class, 'add'])->name('admin_portfolio_category_add')->middleware('admin:admin');
Route::post('/admin/portfolio_category/submit', [AdminPortfolioCategoryController::class, 'store'])->name('admin_portfolio_category_submit')->middleware('admin:admin');
Route::get('/admin/portfolio_category/edit/{id}', [AdminPortfolioCategoryController::class, 'edit'])->name('admin_portfolio_category_edit')->middleware('admin:admin');
Route::post('/admin/portfolio_category/update/{id}', [AdminPortfolioCategoryController::class, 'update'])->name('admin_portfolio_category_update')->middleware('admin:admin');
Route::get('/admin/portfolio_category/delete/{id}', [AdminPortfolioCategoryController::class, 'delete'])->name('admin_portfolio_category_delete')->middleware('admin:admin');
...
Route::get('/admin/post_category/add', [AdminPostCategoryController::class, 'add'])->name('admin_post_category_add')->middleware('admin:admin');
Route::post('/admin/post_category/submit', [AdminPostCategoryController::class, 'store'])->name('admin_post_category_submit')->middleware('admin:admin');
Route::get('/admin/post_category/edit/{id}', [AdminPostCategoryController::class, 'edit'])->name('admin_post_category_edit')->middleware('admin:admin');
Route::post('/admin/post_category/update/{id}', [AdminPostCategoryController::class, 'update'])->name('admin_post_category_update')->middleware('admin:admin');
Route::get('/admin/post_category/delete/{id}', [AdminPostCategoryController::class, 'delete'])->name('admin_post_category_delete')->middleware('admin:admin');
