                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="category_seo_title" {{$row_data->category_seo_title}}>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">SEO Meta Description </label>
                                        <textarea name="category_seo_meta_description" class="form-control h_100" cols="30" rows="10">
                                            {{$row_data->category_seo_meta_description}}
                                        </textarea>
                                    </div>
                                    <div class="mb-4">
