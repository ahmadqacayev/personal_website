                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="seo_title" {{$row_data->seo_title}}>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">SEO Meta Description </label>
                                        <textarea name="seo_meta_description" class="form-control h_100" cols="30" rows="10">
                                            {{$row_data->seo_meta_title}}
                                        </textarea>
                                    </div>
                                    <div class="mb-4">
